...
| :--- | :--- | :---: |
| [`01_strings.py`](01_strings.py) | Strings, String Methods, Escape Sequences | `7` |
| [`02_indexing_and_slicing.py`](02_indexing_and_slicing.py) | Positive/Negative Indexing, Slicing, Step Values | `7` |
| [`03_string_functions.py`](03_string_functions.py) | Built-in Functions, Length, String Manipulation | `7` |
| [`04_conditional_statements.py`](04_conditional_statements.py) | `if`, `elif`, `else`, Logical & Comparison Conditions | `7` |
